...
<div class="wrapper">
      ...
      <li class="nav-item dropdown">
        ...
        @if(isset(Auth::user()->level) && Auth::user()->level == 1)
          <a href="{{url('admin/staff/list')}}" class="dropdown-item">
            <i class="fas fa-users fa-fw"></i> Quản lí nhân viên
          </a>
          <div class="dropdown-divider"></div>
        @endif
          <a href="{{url('admin/staff/profile')}}" class="dropdown-item">
            <i class="fas fa-user-edit fa-fw"></i> Thông tin tài khoảng
          </a>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 <a href="#">gin2511esport</a>.</strong>
    All rights reserved.
...
<!--7/1/2021-->
<script src="{{url('public/ckeditor4.15/ckeditor.js')}}"></script>
